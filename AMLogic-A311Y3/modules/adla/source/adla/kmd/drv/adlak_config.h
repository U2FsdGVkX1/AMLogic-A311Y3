...
#ifndef CONFIG_ADLAK_ENABLE_DEBUGFS
#define CONFIG_ADLAK_ENABLE_DEBUGFS (1)
#endif
...
#ifndef CONFIG_ADLAK_TEE
#define CONFIG_ADLAK_TEE (1)
#endif

#define ADLAK_MAX_NET_IDS 1024  // maximum of 1024 contexts can exist simultaneously

#define ADLAK_HW_VER_GEN2 (2)
#define ADLAK_HW_VER_GEN3B (3)
#define ADLAK_HW_VER_GEN2B (4)
#define ADLAK_HW_VER_DEFAULT (ADLAK_HW_VER_GEN2)
