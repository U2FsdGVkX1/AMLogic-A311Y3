...
enum adlak_mem_type_inner {
    ...
    ADLAK_ENUM_MEMTYPE_INNER_IOVA_WITHIN_4G   = (1 << 10)   //
};
...
struct adlak_mem_operator {
    struct adlak_mem_handle *(*alloc)(void *obj, struct adlak_context_smmu_attr *ctx_smmu_attr,
                                      struct adlak_buf_req *pbuf_req);
    void (*free)(void *obj, struct adlak_context_smmu_attr *ctx_smmu_attr,
     ...
     * @return
     */
    struct adlak_mem_handle *(*attach)(void *obj, struct adlak_context_smmu_attr *ctx_smmu_attr,
     ...
     * @param mm_info
     */
    void (*dettach)(void *obj, struct adlak_context_smmu_attr *ctx_smmu_attr,
                    struct adlak_mem_handle *mm_info);

    int (*mmap)(void *obj, struct adlak_mem_handle *mm_info, void *const vma);
    int (*unmap)(void *obj, struct adlak_mem_handle *mm_info);
    int (*mmap_userspace)(void *obj, struct adlak_mem_handle *mm_info);
    void (*unmap_userspace)(void *obj, struct adlak_mem_handle *mm_info);
    void *(*vmap)(struct adlak_mem_handle *mm_info);
    void (*vunmap)(struct adlak_mem_handle *mm_info);
    int (*cache_flush)(void *obj, struct adlak_mem_handle *mm_info,
                       struct adlak_sync_cache_ext_info *sync_cache_ext_info);
    int (*cache_invalid)(void *obj, struct adlak_mem_handle *mm_info,
                         struct adlak_sync_cache_ext_info *sync_cache_ext_info);
    void (*smmu_init)(void *obj, void *, uint8_t);
    void (*smmu_deinit)(void *obj, void *, uint8_t);
    void (*smmu_tlb_invalidate)(void *obj, struct adlak_context_smmu_attr *ctx_smmu_attr);
    void (*get_usage)(void *obj, struct adlak_mem_usage *usage);
    uint64_t (*get_smmu_entry)(void *obj, struct adlak_context_smmu_attr *ctx_smmu_attr,
                               uint8_t type);
    void (*smmu_tlb_dump)(void *obj, struct adlak_context_smmu_attr *ctx_smmu_attr);
};
...
uint64_t adlak_mem_uid_alloc(uintptr_t val, uint64_t size);
