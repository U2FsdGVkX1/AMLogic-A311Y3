...
struct adlak_submit_task {
    ...
    int32_t  config_size;  // also using for preempt flag
...
struct adlak_model_attr {
    ...
    int64_t  macc_count;
    uint32_t priority;  // task priority [2-high, 1-low, 0-default]
