...
struct adlak_dev_inference {
    ...
    uint32_t            cnt_busy;
    /* nn_loading */
    int                 nn_loading_flag;        /* Whether to record nn_loading */
    adlak_os_ktime_t    nn_loading_start_time;  /* Record start time */
    uint64_t            nn_loading_busy_time_us; /* Busy time accumulated within 1 second (microseconds) */
    adlak_os_ktime_t    nn_loading_last_check_time; /* Last check time */
};
