...
void adlak_mem_create_smmu(struct adlak_device *padlak, void *ptr_smmu, uint8_t type);

void adlak_mem_destroy_smmu(struct adlak_device *padlak, void *ptr_smmu, uint8_t type);
