...
//#ifdef CONFIG_AML_POWER_SAVE_MODE
    ...
    COMMON_PARAM(wfa_en, false, false)
...
module_param_named(wfa_en, aml_mod_params.wfa_en, bool, S_IRUSR | S_IWUSR | S_IRGRP | S_IROTH);
MODULE_PARM_DESC(wfa_en, "A string variable to adjust the config of wfa");
